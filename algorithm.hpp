...
constexpr bool synthesized_cmp_less(const T& t, const U& u) noexcept {
    return t < u;
}

template <typename T, typename U>
constexpr bool synthesized_cmp_greater(const T& t, const U& u) noexcept {
    return u < t;
}

template <typename T, typename U>
constexpr bool synthesized_cmp_equal(const T& t, const U& u) noexcept {
    return !(t < u) && !(u < t);
}

template <typename T, typename U>
constexpr bool synthesized_cmp_not_equal(const T& t, const U& u) noexcept {
    return !synthesized_cmp_equal(t, u);
}

template <typename T, typename U>
constexpr bool synthesized_cmp_less_equal(const T& t, const U& u) noexcept {
    return synthesized_cmp_less(t, u) || synthesized_cmp_equal(t, u);
}

template <typename T, typename U>
constexpr bool synthesized_cmp_greater_equal(const T& t, const U& u) noexcept {
...
template <typename T, typename U>
constexpr typename T::size_type erase(T& c, const U& value) noexcept {
...
constexpr typename T::size_type erase_if(T& c, Pred pred) noexcept {
    auto old_size = c.size();
...
template <typename T>
constexpr const T& max_of(const T& a, const T& b) noexcept {
    return a < b ? b : a;
}

// max (2) https://en.cppreference.com/w/cpp/algorithm/max
template <typename T, typename Compare>
constexpr const T& max_of(const T& a, const T& b, Compare comp) noexcept {
    return comp(a, b) ? b : a;
}
...
template <typename T>
constexpr const T& min_of(const T& a, const T& b) noexcept {
    return a < b ? a : b;
}

// min (2) https://en.cppreference.com/w/cpp/algorithm/min
template <typename T, typename Compare>
constexpr const T& min_of(const T& a, const T& b, Compare comp) noexcept {
    return comp(a, b) ? a : b;
}
...
constexpr bool equal(InputIt1 first1, InputIt1 last1, InputIt2 first2, BinaryPredicate p) noexcept {
...
template <typename InputIt1, typename InputIt2>
constexpr bool equal(InputIt1 first1, InputIt1 last1, InputIt2 first2, InputIt2 last2) noexcept {
    return equal(
...
template <typename InputIt1, typename InputIt2, typename BinaryPredicate>
constexpr bool equal(InputIt1 first1, InputIt1 last1, InputIt2 first2, InputIt2 last2, BinaryPredicate p) noexcept {
...
template <typename InputIt1, typename InputIt2>
constexpr bool lexicographical_compare(InputIt1 first1, InputIt1 last1, InputIt2 first2, InputIt2 last2) noexcept {
    return lexicographical_compare(
        first1, first2, first2, last2,
...
constexpr bool lexicographical_compare(InputIt1 first1, InputIt1 last1, InputIt2 first2, InputIt2 last2, Compare comp) noexcept {
    for (; first1 != last1 && first2 != last2; ++first1, ++first2) {
